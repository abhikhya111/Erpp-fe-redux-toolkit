...
// import { Delete, ScheduleOutlined } from "@material-ui/icons";
import {
  Scheduler,
  MonthView,
  Appointments,
...
export const TimeSheet = props => {
  ...
  React.useEffect(() => {
    setTimesheet(props.all_attendances);
    ...
    return (
      ...
      >
        ...
        >
          <Grid item xs={12} md={12} lg={7}>
            ...
            >
              ...
              {/* <h2 style={{marginRight: "10px"}}>Name LastName (E123456789) </h2>
                                        <p style={{display: "flex", alignItems: "center", marginRight: "10px"}}> | Business Analyst | Site Simple name</p> */}
              <Typography
                component={"span"}
                variant="h6"
                style={{
        ...
        <Grid
          ...
          style={{ display: "flex", flexDirection: "row" }}
        >
          <Grid item xs={12} md={12} lg={3} style={{}}></Grid>
          <Grid
            item
            xs={12}
            md={6}
          ...
          >
            ...
            <p style={{ margin: "0px 0px 0px 2px", fontSize: "1em" }}>Absent</p>
          </Grid>
          <Grid
            item
            xs={12}
          ...
          {/* <Paper>
                                <Scheduler data={schedulerData} height={660}>
                                    ...
                                    onCurrentDateChange={newCurrentName =>
                                        console.log("newCurrentName", newCurrentName)
                                    }
  ...
  return (
    <React.Fragment>
      {!viewDetails ? getTimeSheetLandingPage() : getViewDetailsPage()}
    </React.Fragment>
  );
};
